...
\usepackage{array}
\usepackage{tabulary}
% paquete para para quebrar lineas de links
\usepackage{breakurl}
% paquete para letra arial
\usepackage{helvet}
...
\emph{\textbf{(Máximo 1/2 página)}}
% Si desea generar una tabla de forma sencilla puede utilizar: http://www.tablesgenerator.com/
